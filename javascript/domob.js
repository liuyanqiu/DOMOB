...
//移除obj对应的class
    ...
    //table
    function f(n) {
        var elem = document.getElementById("hotnews_caption");
        var elemlist = elem.getElementsByTagName("li");
        for (var i=0; i<elemlist.length; i++) {
            elemlist[i].className = "normal";  var m = i+1;
...
function tab(n) {
    ...
    var elemlist = elem.getElementsByTagName("li");
    for (var i=0; i<elemlist.length; i++) {
        elemlist[i].className = "normal_1";  var m = i+1;
        document.getElementById("page_"+m).className = "normal_1";
    }
    elemlist[n-1].className = "current_1";
    document.getElementById("page_"+n).className = "current_1";
}